...
run_bash_syntax_checks() {
  ...
  python3 -m py_compile "$ROOT/tests/test-base-checkout-contract.py"
  python3 -m py_compile "$ROOT/tests/test-eval-result-inbound-refs.py"
  python3 -m py_compile "$ROOT/tests/test-split-destination-proof.py"
